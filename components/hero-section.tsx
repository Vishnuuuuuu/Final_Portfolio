      ...
      <div className="container relative mx-auto flex min-h-screen flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        >
          {[
            {
              icon: "🚀",
              text: "Proficient in Node.js, React.js, and MongoDB for building complete solutions...",
            },
            {
              icon: "💻",
              text: "Skilled in Java, JavaScript, Python, AI/ML, and No-code tools...",
            },
            {
              icon: "🌐",
              text: "Experienced in developing web technologies and products...",
            },
            {
              icon: "🤖",
              text: "Actively exploring Artificial Intelligence applications...",
            },
            {
              icon: "💡",
              text: "Working on AI and Prompt Engineering advancements...",
            },
          ].map((item, index) => (
            <motion.div
              key={index}
        ...
        >
          ...
          >
            <a
              href="https://github.com/Vishnuuuuuu"
              target="_blank"
          ...
          >
            <a
              href="https://www.linkedin.com/in/vishnu-prasad-s-862b5b1bb/"
              target="_blank"
              rel="noopener noreferrer"
            >
          ...
          <Button
            ...
            asChild
          >
            <a href="/Vishnu_resume_2025.pdf" download>
